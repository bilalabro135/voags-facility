                                ...
                                <table class="table table-stripped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                               <a href="{{url('service_areas').'/'.$service_area->id}}"> <button type="button" class="btn btn-sm btn-primary mr-2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
